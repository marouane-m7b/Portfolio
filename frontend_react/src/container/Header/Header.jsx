...
const Header = () => (
  <div className="app__header app__flex">
    ...
    >
      <img loading="lazy" src={images.profile} alt="marouane mahboub profile" />
      <motion.img
