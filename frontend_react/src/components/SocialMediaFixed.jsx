...
const SocialMediaFixed = () => (
  <div className="app__social-fixed">
    ...
    <a href="https://wa.me/+212600000000" target="_blank" rel="noreferrer" aria-label="Whatsapp Link" data-tooltip-id="my-tooltip" data-tooltip-content="Whatsapp">
      <FaWhatsapp />
    </a>
    <a href="https://www.youtube.com/channel/UC9y9wJ9kO2Qn9NwG2Kb7WkA" target="_blank" rel="noreferrer" aria-label="Youtube Link" data-tooltip-id="my-tooltip" data-tooltip-content="Youtube">
      <FaYoutube />
    </a>
